...
global.nameown = 'LeonOfc'

/*============== Github Thanks To ==============*/
global.namagithub = 'LeonOfc202' // nama github lu
global.linkgithub = 'github.com/LeonOfc202' // tarok link github lu
...
/*============== WATERMARK ==============*/
global.wm = '                「 Lavender-BOT 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Lavender-BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Lavender-BOT '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Zenss`
global.packname = 'Lavender-Botz WhatsApp'
global.author = '                「 Lavender-BOT  あ」'
